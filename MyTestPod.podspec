...
#s.license      = "MIT"
s.license      = { :type => "Commercial", :text => "http://developer.samsung.com/end-user-license" }
...
s.preserve_paths    = "SmartViewSDK-iOS/**/*.*"
s.vendored_frameworks   = "SmartViewSDK-iOS/iphoneos+iphonesimulator/SmartView.framework"
#s.vendored_frameworks   = "SmartViewSDK-iOS/**/*.framework" # does not work  01Feb2017
#s.vendored_frameworks   = "SmartViewSDK-iOS/iphoneos+iphonesimulator/SmartView.framework", "SmartViewSDK-iOS/iphoneos/SmartView.framework"  # <<--does not work
